...
async function createRawTransaction(
  ...
  //IoT data encryption
  var ciphertext = CryptoJS.AES.encrypt(JSON.stringify(description), 'my-secret-key@123').toString();
...
class Upload extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      title: "", // contains video title inputed by user
  ...
  onSubmit = async (event) => {
    ...
    //  this.setState({ thumbnailHash: thumbnailUpload.cid.toString() });
     // this.setState({ videoHash: videoUpload.cid.toString() });
      ...
      await setDoc(doc(db, "data", id.toString()), {
        id: id,
        likes: 0,
      });
    }
      ...
      <div className="upload">
        ...
        <div className="section-title">
          ...
          <div
            ...
            className="uf"
          >
            <form className="form-inline" style={{ paddingBottom: "60px" }}>
              <h6 className="uf-lable">Title:</h6>
              <input
            ...
            <form className="form-inline" style={{ paddingBottom: "60px" }}>
              <h6 className="uf-lable">Insert Data:</h6>
              <input
                style={{}}
                className="uf-input"
                type="text"
